...
public class WindTurbineBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:windturbine")
	public static final Block block = null;
	public WindTurbineBlock(InfiniteIndustryElements instance) {
		super(instance, 57);
	}

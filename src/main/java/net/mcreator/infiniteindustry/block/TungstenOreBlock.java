...
public class TungstenOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:tungstenore")
	public static final Block block = null;
	public TungstenOreBlock(InfiniteIndustryElements instance) {
		super(instance, 89);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tungstenore", "tungstenore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(5, 6, 6, 45)));
		}
	}
}

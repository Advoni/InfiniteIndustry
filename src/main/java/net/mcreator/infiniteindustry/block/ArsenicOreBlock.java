...
public class ArsenicOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:arsenicore")
	public static final Block block = null;
	public ArsenicOreBlock(InfiniteIndustryElements instance) {
		super(instance, 100);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("arsenicore", "arsenicore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 10), Placement.COUNT_RANGE, new CountRangeConfig(8, 30, 30, 64)));
		}
	}
}

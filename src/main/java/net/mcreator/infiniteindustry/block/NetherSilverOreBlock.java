...
public class NetherSilverOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:nethersilverore")
	public static final Block block = null;
	public NetherSilverOreBlock(InfiniteIndustryElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nethersilverore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("nethersilverore", "nethersilverore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.NETHERRACK.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6), Placement.COUNT_RANGE, new CountRangeConfig(10, 1, 1, 255)));
		}
	}
}

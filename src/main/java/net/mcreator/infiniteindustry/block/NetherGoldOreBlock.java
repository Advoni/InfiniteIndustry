...
public class NetherGoldOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:nethergoldore")
	public static final Block block = null;
	public NetherGoldOreBlock(InfiniteIndustryElements instance) {
		super(instance, 32);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("nethergoldore", "nethergoldore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.NETHERRACK.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(5, 1, 1, 255)));
		}
	}
}

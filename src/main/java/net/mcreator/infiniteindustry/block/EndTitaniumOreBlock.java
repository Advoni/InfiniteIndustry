...
public class EndTitaniumOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:endtitaniumore")
	public static final Block block = null;
	public EndTitaniumOreBlock(InfiniteIndustryElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("endtitaniumore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("endtitaniumore", "endtitaniumore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.END_STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 1), Placement.COUNT_RANGE, new CountRangeConfig(1, 1, 1, 255)));
		}
	}
}

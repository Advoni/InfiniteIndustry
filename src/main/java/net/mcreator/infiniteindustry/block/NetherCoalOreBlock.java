...
public class NetherCoalOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:nethercoalore")
	public static final Block block = null;
	public NetherCoalOreBlock(InfiniteIndustryElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 30f).lightValue(0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("nethercoalore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("nethercoalore", "nethercoalore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.NETHERRACK.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6), Placement.COUNT_RANGE, new CountRangeConfig(18, 1, 1, 255)));
		}
	}
}

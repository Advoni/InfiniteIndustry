...
public class NetherCobaltOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:nethercobaltore")
	public static final Block block = null;
	public NetherCobaltOreBlock(InfiniteIndustryElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nethercobaltore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("nethercobaltore", "nethercobaltore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.NETHERRACK.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 9), Placement.COUNT_RANGE, new CountRangeConfig(3, 1, 1, 255)));
		}
	}
}

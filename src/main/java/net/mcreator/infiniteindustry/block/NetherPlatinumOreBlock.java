...
public class NetherPlatinumOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:netherplatinumore")
	public static final Block block = null;
	public NetherPlatinumOreBlock(InfiniteIndustryElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("netherplatinumore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("netherplatinumore", "netherplatinumore", blockAt -> {

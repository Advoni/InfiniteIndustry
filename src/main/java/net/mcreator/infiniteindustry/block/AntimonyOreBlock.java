...
public class AntimonyOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:antimonyore")
	public static final Block block = null;
	public AntimonyOreBlock(InfiniteIndustryElements instance) {
		super(instance, 86);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("antimonyore", "antimonyore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 3), Placement.COUNT_RANGE, new CountRangeConfig(2, 7, 7, 13)));
		}
	}
}

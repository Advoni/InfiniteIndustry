...
public class EndDiamondOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:enddiamondore")
	public static final Block block = null;
	public EndDiamondOreBlock(InfiniteIndustryElements instance) {
		super(instance, 103);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("enddiamondore", "enddiamondore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.END_STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 8), Placement.COUNT_RANGE, new CountRangeConfig(3, 1, 1, 255)));
		}
	}
}

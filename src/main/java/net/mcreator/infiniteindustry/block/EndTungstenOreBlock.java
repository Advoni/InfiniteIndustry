...
public class EndTungstenOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:endtungstenore")
	public static final Block block = null;
	public EndTungstenOreBlock(InfiniteIndustryElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("endtungstenore");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("endtungstenore", "endtungstenore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.END_STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 3), Placement.COUNT_RANGE, new CountRangeConfig(3, 30, 30, 140)));
		}
	}
}

...
import net.mcreator.infiniteindustry.procedures.AdvancedPistonRodBlockDestroyedByPlayerRedstoneOnProcedure;
import net.mcreator.infiniteindustry.procedures.AdvancedPistonBlockUpdateTickProcedure;
...
public class AdvancedPistonBlockBlock extends InfiniteIndustryElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("advancedpistonblock"));
	}
	public static class CustomBlock extends Block {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					AdvancedPistonRodBlockDestroyedByPlayerRedstoneOnProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				AdvancedPistonBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("advancedpistonblock");
		}

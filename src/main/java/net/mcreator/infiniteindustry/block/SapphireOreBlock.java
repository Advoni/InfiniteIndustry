...
import net.mcreator.infiniteindustry.item.SapphireItem;
...
public class SapphireOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:sapphireore")
	public static final Block block = null;
	public SapphireOreBlock(InfiniteIndustryElements instance) {
		super(instance, 7);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("sapphireore", "sapphireore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 3), Placement.COUNT_RANGE, new CountRangeConfig(2, 5, 5, 8)));
		}
	}
}

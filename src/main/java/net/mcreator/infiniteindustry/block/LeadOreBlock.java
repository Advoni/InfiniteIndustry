...
public class LeadOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:leadore")
	public static final Block block = null;
	public LeadOreBlock(InfiniteIndustryElements instance) {
		super(instance, 26);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("leadore", "leadore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(13, 10, 10, 35)));
		}
	}
}

...
import net.mcreator.infiniteindustry.item.PeridotItem;
...
public class PeridotOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:peridotore")
	public static final Block block = null;
	public PeridotOreBlock(InfiniteIndustryElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PeridotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("peridotore", "peridotore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 3), Placement.COUNT_RANGE, new CountRangeConfig(1, 5, 5, 8)));
		}
	}
}

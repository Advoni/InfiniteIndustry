...
public class CopperOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:copperore")
	public static final Block block = null;
	public CopperOreBlock(InfiniteIndustryElements instance) {
		super(instance, 13);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(10, 30, 30, 50)));
		}
	}
}

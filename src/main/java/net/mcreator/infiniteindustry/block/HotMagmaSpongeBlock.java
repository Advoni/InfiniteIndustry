...
import net.mcreator.infiniteindustry.procedures.HotMagmaSpongeBlockDestroyedByPlayerProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.FALLING_LAVA, d0, d1, d2, d3, d4, d5);
				}
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				HotMagmaSpongeBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}

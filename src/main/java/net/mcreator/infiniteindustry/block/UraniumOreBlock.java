...
public class UraniumOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:uraniumore")
	public static final Block block = null;
	public UraniumOreBlock(InfiniteIndustryElements instance) {
		super(instance, 111);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 2), Placement.COUNT_RANGE, new CountRangeConfig(6, 16, 16, 32)));
		}
	}
}

...
import net.mcreator.infiniteindustry.item.RubyItem;
...
public class RubyOreBlock extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:rubyore")
	public static final Block block = null;
	public RubyOreBlock(InfiniteIndustryElements instance) {
		super(instance, 8);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 4), Placement.COUNT_RANGE, new CountRangeConfig(2, 5, 5, 10)));
		}
	}
}

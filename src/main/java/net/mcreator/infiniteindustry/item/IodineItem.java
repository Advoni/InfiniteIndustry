...
public class IodineItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:iodine")
	public static final Item block = null;
	public IodineItem(InfiniteIndustryElements instance) {
		super(instance, 96);
	}

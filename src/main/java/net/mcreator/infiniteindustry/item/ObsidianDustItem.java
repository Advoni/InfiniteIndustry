...
public class ObsidianDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:obsidiandust")
	public static final Item block = null;
	public ObsidianDustItem(InfiniteIndustryElements instance) {
		super(instance, 31);
	}

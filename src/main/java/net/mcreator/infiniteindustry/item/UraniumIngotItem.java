...
public class UraniumIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:uraniumingot")
	public static final Item block = null;
	public UraniumIngotItem(InfiniteIndustryElements instance) {
		super(instance, 37);
	}

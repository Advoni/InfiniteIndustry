...
public class AquamarineItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:aquamarine")
	public static final Item block = null;
	public AquamarineItem(InfiniteIndustryElements instance) {
		super(instance, 20);
	}

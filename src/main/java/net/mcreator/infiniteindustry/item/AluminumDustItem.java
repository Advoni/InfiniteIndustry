...
public class AluminumDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:aluminumdust")
	public static final Item block = null;
	public AluminumDustItem(InfiniteIndustryElements instance) {
		super(instance, 21);
	}

...
public class AntimonyIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:antimonyingot")
	public static final Item block = null;
	public AntimonyIngotItem(InfiniteIndustryElements instance) {
		super(instance, 40);
	}

...
public class NickelIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:nickelingot")
	public static final Item block = null;
	public NickelIngotItem(InfiniteIndustryElements instance) {
		super(instance, 38);
	}

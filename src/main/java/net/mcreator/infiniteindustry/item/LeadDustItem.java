...
public class LeadDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:leaddust")
	public static final Item block = null;
	public LeadDustItem(InfiniteIndustryElements instance) {
		super(instance, 24);
	}

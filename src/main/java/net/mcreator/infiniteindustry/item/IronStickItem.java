...
public class IronStickItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:ironstick")
	public static final Item block = null;
	public IronStickItem(InfiniteIndustryElements instance) {
		super(instance, 82);
	}

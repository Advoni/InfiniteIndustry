...
public class PearlItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:pearl")
	public static final Item block = null;
	public PearlItem(InfiniteIndustryElements instance) {
		super(instance, 27);
	}

...
public class IronGearItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:irongear")
	public static final Item block = null;
	public IronGearItem(InfiniteIndustryElements instance) {
		super(instance, 129);
	}

...
public class AluminumIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:aluminumingot")
	public static final Item block = null;
	public AluminumIngotItem(InfiniteIndustryElements instance) {
		super(instance, 22);
	}

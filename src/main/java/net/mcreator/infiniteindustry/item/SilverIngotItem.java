...
public class SilverIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:silveringot")
	public static final Item block = null;
	public SilverIngotItem(InfiniteIndustryElements instance) {
		super(instance, 15);
	}

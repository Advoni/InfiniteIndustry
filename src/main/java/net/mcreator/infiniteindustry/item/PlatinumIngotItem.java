...
public class PlatinumIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:platinumingot")
	public static final Item block = null;
	public PlatinumIngotItem(InfiniteIndustryElements instance) {
		super(instance, 12);
	}

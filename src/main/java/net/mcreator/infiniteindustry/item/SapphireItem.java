...
public class SapphireItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:sapphire")
	public static final Item block = null;
	public SapphireItem(InfiniteIndustryElements instance) {
		super(instance, 1);
	}

...
public class ChromiumIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:chromiumingot")
	public static final Item block = null;
	public ChromiumIngotItem(InfiniteIndustryElements instance) {
		super(instance, 39);
	}

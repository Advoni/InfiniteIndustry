...
public class BottleItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:bottle")
	public static final Item block = null;
	public BottleItem(InfiniteIndustryElements instance) {
		super(instance, 122);
	}

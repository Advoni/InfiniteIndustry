...
public class SulfurItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:sulfur")
	public static final Item block = null;
	public SulfurItem(InfiniteIndustryElements instance) {
		super(instance, 93);
	}

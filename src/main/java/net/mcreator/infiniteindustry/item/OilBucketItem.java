...
public class OilBucketItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:oilbucket")
	public static final Item block = null;
	public OilBucketItem(InfiniteIndustryElements instance) {
		super(instance, 120);
	}

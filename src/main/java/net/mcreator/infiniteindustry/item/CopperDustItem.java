...
public class CopperDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:copperdust")
	public static final Item block = null;
	public CopperDustItem(InfiniteIndustryElements instance) {
		super(instance, 17);
	}

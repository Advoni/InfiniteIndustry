...
public class LeadIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:leadingot")
	public static final Item block = null;
	public LeadIngotItem(InfiniteIndustryElements instance) {
		super(instance, 25);
	}

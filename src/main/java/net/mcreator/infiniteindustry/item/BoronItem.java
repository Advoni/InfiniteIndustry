...
public class BoronItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:boron")
	public static final Item block = null;
	public BoronItem(InfiniteIndustryElements instance) {
		super(instance, 97);
	}

...
public class TitaniumIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:titaniumingot")
	public static final Item block = null;
	public TitaniumIngotItem(InfiniteIndustryElements instance) {
		super(instance, 104);
	}

...
public class PhosphorusItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:phosphorus")
	public static final Item block = null;
	public PhosphorusItem(InfiniteIndustryElements instance) {
		super(instance, 95);
	}

...
public class PeridotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:peridot")
	public static final Item block = null;
	public PeridotItem(InfiniteIndustryElements instance) {
		super(instance, 14);
	}

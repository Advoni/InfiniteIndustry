...
public class PlatinumDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:platinumdust")
	public static final Item block = null;
	public PlatinumDustItem(InfiniteIndustryElements instance) {
		super(instance, 18);
	}

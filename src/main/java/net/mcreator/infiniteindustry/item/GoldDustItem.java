...
public class GoldDustItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:golddust")
	public static final Item block = null;
	public GoldDustItem(InfiniteIndustryElements instance) {
		super(instance, 98);
	}

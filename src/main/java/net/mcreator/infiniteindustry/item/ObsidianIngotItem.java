...
public class ObsidianIngotItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:obsidianingot")
	public static final Item block = null;
	public ObsidianIngotItem(InfiniteIndustryElements instance) {
		super(instance, 2);
	}

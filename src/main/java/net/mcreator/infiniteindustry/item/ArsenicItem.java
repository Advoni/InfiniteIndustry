...
public class ArsenicItem extends InfiniteIndustryElements.ModElement {
	@ObjectHolder("infiniteindustry:arsenic")
	public static final Item block = null;
	public ArsenicItem(InfiniteIndustryElements instance) {
		super(instance, 99);
	}
